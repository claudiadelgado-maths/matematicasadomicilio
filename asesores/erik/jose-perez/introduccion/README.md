...
Veinte vistas dentro de un solo `index.html`: bases aritméticas y algebraicas; puntos; distancia; pendiente; recta; funciones; dominio e imagen; familias; límites; laterales y discontinuidades; derivada; reglas; vectores; varias variables; parciales; integral indefinida; definida; métodos; múltiples; cierre.
...
- `estilos.css`: apariencia exclusiva, tamaños responsivos y movimiento reducido.
