...
Parte de Repaso de Raúl (Erik). Todo mezclado: práctica dinámica con ejemplos visuales y feedback.
...
Continúa en `../sustitucion/index.html`: primera página de Sustitución y evaluación de expresiones.
