...
- `academia.json`: relaciona maestros activos, alumnos activos y sesiones publicadas. Alimenta `/asesores/`, los índices de alumnos, los perfiles de maestros y los costos de la portada.
