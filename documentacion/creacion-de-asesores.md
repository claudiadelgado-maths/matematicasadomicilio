...
Después ejecuta `npm run catalogo` y `npm run validar`. El nuevo asesor aparecerá automáticamente en `/asesores/`, su perfil se publicará en `/asesores/<slug>/` y sus opciones de sesión se mostrarán dentro de su salón.
